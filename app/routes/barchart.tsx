...
const SimpleBarChart = () => {
  const { data, request: requestFunction } = useApi(`${https}${host}${port}${rest}`);
  ...
  const colors = ['#8884d8', '#82ca9d', '#ffc658', '#0088FE', '#00C49F', '#FFBB28', '#FF8042']; // Fügen Sie so viele Farben hinzu, wie Sie benötigen
